...
EFFECT_SIZES_JSON = STAT_DIR / "effect_sizes_truehr.json"

# Eval JSONs with per_image_metrics
EVAL_JSONS = {
    "mrnet": {
        "MedVAE SR": EXP_DIR / "mrnet_medvae_s1_truehr/diffusion_eval_results.json",
        "SD-VAE SR": EXP_DIR / "mrnet_sdvae_truehr/diffusion_eval_results.json",
    },
    "brats": {
        "MedVAE SR": EXP_DIR / "brats_medvae_s1_valid_truehr/diffusion_eval_results.json",
        "SD-VAE SR": EXP_DIR / "brats_sdvae_valid_truehr/diffusion_eval_results.json",
    },
    "cxr": {
        "MedVAE SR": EXP_DIR / "cxr_medvae_s1_truehr/diffusion_eval_results.json",
        "SD-VAE SR": EXP_DIR / "cxr_sdvae_truehr/diffusion_eval_results.json",
    },
}
...
def main():
    ...
    # Save
    out_png = FIG_DIR / "paper1_fig6_truehr.png"
    out_pdf = FIG_DIR / "paper1_fig6_truehr.pdf"
