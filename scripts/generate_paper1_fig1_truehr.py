...
STATS   = REPO / "outputs" / "statistical_tests" / "effect_sizes_truehr.json"
...
def build_data():
    exp_map = {
        "MRNet": {
            ...
            "swinir":    "mrnet_swinir",
            "sdvae_sr":  "mrnet_sdvae_truehr",
            "medvae_sr": "mrnet_medvae_s1_truehr",
        ...
        "BraTS": {
            ...
            "swinir":    "brats_swinir",
            "sdvae_sr":  "brats_sdvae_valid_truehr",
            "medvae_sr": "brats_medvae_s1_valid_truehr",
        ...
        "CXR": {
            ...
            "swinir":    "cxr_swinir",
            "sdvae_sr":  "cxr_sdvae_truehr",
            "medvae_sr": "cxr_medvae_s1_truehr",
            "medvae_ae": "cxr_medvae_ae",
        },
    }
    mrnet_lpips = EXP / "does_not_exist_truehr" / "diffusion_eval_results.json"
...
def make_figure(data, cis):
    ...
    for ax_idx, (metric_key, metric_label, higher_better) in enumerate(METRICS):
        ...
        for ds_idx, ds in enumerate(DATASETS):
            if metric_key != "psnr":
                continue  # true-HR: LPIPS is no longer a uniform MedVAE win (MRNet flips); drop improvement brackets, show bars only
...
def main():
    ...
    out_png = OUT_DIR / "paper1_fig1_truehr.png"
    out_pdf = OUT_DIR / "paper1_fig1_truehr.pdf"
