...
# MRNet + MedVAE 4_1_2d (1-channel latent, 1x64x64 = 4096 floats).
# Capacity-matched medical control vs SD-VAE (4x32x32 = 4096 floats).
# Reference-based metrics only (PSNR/MS-SSIM/LPIPS). No downstream (Leo constraint).
# Results namespaced under outputs/experiments/revision_capacity/ to avoid collision.
# ============================================================
...
LATENT_DIR="${OUT_BASE}/embeddings/medvae_4_1_mrnet_s1"
WEIGHT_DIR="${OUT_BASE}/weights/diffusion_medvae_4_1_mrnet_s1_x0"
EVAL_DIR="outputs/experiments/revision_capacity/mrnet_medvae_4_1_s1"
AE_DIR="outputs/experiments/revision_capacity/mrnet_medvae_4_1_ae"

EXPERIMENT=rev_mrnet_medvae_4_1
...
# Step 3: Evaluate SR quality on validation set (n=120, matches paper)
echo ""
