...
# CXR + MedVAE: 8K training images → needs ~9h for 100 epochs.
...
LATENT_DIR="${OUT_BASE}/embeddings/medvae_4_3_2d_cxr"
WEIGHT_DIR="${OUT_BASE}/weights/diffusion_medvae_cxr_x0"
EVAL_DIR="outputs/experiments/cxr_medvae"
