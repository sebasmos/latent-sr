...
# Issue #77 Path A — Rectified Flow (MedVAE) — MRNet dataset
...
EVAL_DIR="outputs/experiments/mrnet_flow_matching"

LOG_FILE="slurm/experiments/flow_matching_mrnet_${SLURM_JOB_ID}.log"
mkdir -p slurm/experiments
exec > >(tee -a "$LOG_FILE") 2>&1

echo "========================================="
echo "MRNet Flow Matching SR — Issue #77 Path A"
echo "Job: $SLURM_JOB_ID | Node: $(hostname) | Date: $(date)"
echo "========================================="
nvidia-smi 2>/dev/null | head -5

########################################################################
# Step 1: Train rectified flow model on MRNet MedVAE latents
########################################################################
echo ""
echo "=== Training MRNet MedVAE rectified flow model ==="
...
echo ""
echo "========================================="
echo "MRNet flow matching complete at: $(date)"
